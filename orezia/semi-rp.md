...
![Maître Deméh Tié est situé au spawn, en face de toi quand tu arrives !](../.gitbook/assets/2022-04-28_15.21.52.png)
...
![Rhank Eup est situé au spawn, à ta droite quand tu arrives !](../.gitbook/assets/2022-04-28_15.21.35.png)
...
![Exemple de pré-requis (pour le rang Paysan)](<../.gitbook/assets/rankuperrant1 (1).jpg>)
...
{% content-ref url="/broken/pages/-MYfZbAspBG4DDTsasbX" %}
...
![Il est situé au spawn, à ta gauche quand tu arrives !](../.gitbook/assets/2022-04-28_15.21.41.png)
...
* Tu peux décider de t'aventurer dans le **monde ressources** et construire ta base là-bas mais prends garde à t'éloigner du spawn (grâce au `/rt`) et à **bien cacher ta base** car le **pillage et le grief sont autorisés sur ce monde**.<br>
* Tu peux **rejoindre une ville** en tant que **membre**, tes ressources seront sécurisées et ne seront accessibles que par toi et ceux que tu auras choisis comme compagnons.\
  Pour devenir membre d'une ville, il faut qu'un propriétaire t'accorde sa confiance et qu'il décide de te recruter pour faire partie de son projet.<br>
...
![](../.gitbook/assets/2022-04-28_15.30.44.png)
...
![Le Maître Dékon Thinant est à ta gauche quand tu arrives au spawn !](../.gitbook/assets/2022-04-28_15.21.47.png)
...
{% content-ref url="/broken/pages/-MYfZgYaJz9pqch4S_zm" %}
